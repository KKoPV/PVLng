...
})->name('/sunrise/:latitude/:longitude(/:date)')->help = array(
    'since'       => 'r3',
...
})->name('/sunset/:latitude/:longitude(/:date)')->help = array(
    'since'       => 'r3',
...
})->name('/daylight(/:offset)')->help = array(
    'since'       => 'r3',
...
})->name('/daylight/:latitude/:longitude(/:offset)')->help = array(
    'since'       => 'r3',
