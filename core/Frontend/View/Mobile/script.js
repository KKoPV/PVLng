...
function updateChart(changed) {
    ...
    var options = $.extend(true, {}, ChartOptions), loading = view.length;
    ...
    if (window.innerWidth < minWidthForYAxis) {
        options.chart.spacingTop = 5;
        options.chart.spacingBottom = 5;
        options.chart.alignTicks = false;
        /* Hide axes & labels on smaller screens */
        $.each(yAxis, function(i) {
            yAxis[i].title = { enabled: false };
