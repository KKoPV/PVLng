            ...
            $(data).each(function(id, row) {
                ...
                listTable.fnAddData(
                    [
                        ...
                        channel.numeric ? +row.min.toFixed(channel.decimals) : '',
                        channel.numeric ? +row.max.toFixed(channel.decimals) : '',
                        channel.numeric && channel.meter ? +row.consumption.toFixed(channel.decimals) : '',
                        row.count,
                        delbtn
                    ],
                    false
...
$(function() {
    ...
    $('#edit-entity').click(function() {
        window.location.href = '/channels/edit/' + $(this).data('guid') + '?returnto=/list/' + $(this).data('guid');
    });
