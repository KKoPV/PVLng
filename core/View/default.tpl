...
<body>
    ...
    <div id="container" class="container_10" style="opacity:0">
        ...
        <div id="header" class="grid_10 no-print">
            ...
            <div class="grid_2 alpha s">
                ...
                <div class="b" style="margin-left:120px">
                    ...
                    <!-- ENDIF -->
                    <!-- EVENT body_header_left_version_after_html -->
                </div>
                <!-- EVENT body_header_left_after_html -->
            </div>

            <div class="grid_4 c">
                <!-- EVENT body_header_center_before_html -->
                <h3 style="margin-top:.5em;margin-bottom:0">{SUBTITLE}</h3>
                <!-- EVENT body_header_center_after_html -->
            </div>

            <div class="r">
                <!-- EVENT body_header_right_before_html -->
                <span id="title1">{TITLE}</span>
                <!-- IF {USER} AND {TOKEN} -->
                <!-- EVENT body_header_right_user_before_html -->
                <br /><a href="/login/{TOKEN}" class="tip" title="{{LoginToken}}">&bull;</a>
                <!-- EVENT body_header_right_user_after_html -->
                <!-- ENDIF -->
                <!-- EVENT body_header_right_after_html -->
            </div>

            <div class="clear"></div>

            <!-- EVENT body_header_after_html -->
        ...
        <div id="menu" class="grid_10 no-print">
            ...
            <!-- EVENT body_menu_before_html -->

            <div class="ui-widget-header ui-corner-all" style="height:35px">

                <!-- EVENT body_menu_left_before_html -->
                ...
                <!-- EVENT body_menu_left_middle_html -->

                <div class="fl extra"></div>

                <!-- EVENT body_menu_middle_right_html -->
                ...
                <!-- EVENT body_menu_right_after_html -->

            </div>

            <!-- EVENT body_menu_after_html -->
        ...
        <!-- EVENT body_content_before_html -->

        <div id="content" role="main" class="grid_10">
            <!-- EVENT body_content_content_before_html -->
            {CONTENT}
            <!-- EVENT body_content_content_after_html -->
        </div>

        <div class="clear"></div>

        <!-- EVENT body_content_after_html -->

        <!-- IF !{EMBEDDED} -->

        <!-- EVENT body_footer_before_html -->

        <div id="footer" class="grid_10 xs no-print">
            <div class="ui-widget-header ui-corner-all">
                <!-- EVENT body_footer_inner_before_html -->
                <div class="fl icons">
                ...
                <!-- EVENT body_footer_inner_after_html -->
            </div>
        </div>

        <div class="clear"></div>

        <!-- EVENT body_footer_after_html -->
        ...
        <!-- EVENT body_container_after_html -->
    ...
    <script>
        ...
        /**
         * DataTables can use cookies in the end user's web-browser in order to store
         * it's state after each change in drawing. What this means is that if the user
         * were to reload the page, the table should remain exactly as it was (length,
         * filtering, pagination and sorting). This is disabled by default.
         */
        var DatatablesStateSave = false;
        <!-- EVENT body_config_js -->
    </script>

    <!-- EVENT javascript_files_before_html -->
    ...
    <!-- EVENT javascript_files_after_html -->
    ...
    <script>
        ...
        $(function($) {
            ...
            /**
             * Setup AJAX before controller specific scripts!
             */
            if (user) {
                $.ajaxSetup({
