 ...
 *
 * Uses this vars:
 * - content - convert to XML (required)
 *
 * @author      Knut Kohl <github@knutkohl.de>
 * @copyright   2012-2013 Knut Kohl
 * @license     GNU General Public License http://www.gnu.org/licenses/gpl.txt
	...
	public function output() {
		...
		if (is_resource($this->content)) {
			...
			$content = array(
				...
				$this->config->get('View.XML.Data', 'data') => (array)$this->content,
			);

			Array2XML::Init('1.0', 'UTF-8',
			                ($this->config->get('View.Verbose') OR $this->Plain));

			echo Array2XML::createXML($node, $content)->saveXML();
		}
	}
...
class Array2XML {
		 ...
		 * @return DOMNode
		 */
		public static function &convert($node_name, $arr=array()) {
