...
var PVLngOnLoad = function(c,o,d,i,n,g){function x(){for(g=1;c.length;)c.shift()()}o[i]?(d[i]('DOMContentLoaded',x,0),o[i]('load',x,0)):(d[n]('onreadystatechange',function(){d.readyState=='complete'&&x()}),o[n]('onload',x));return function(t){g?o.setTimeout(t,0):c.push(t)}}([],window,document,'addEventListener','attachEvent');
