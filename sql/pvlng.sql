...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE  FUNCTION `pvlng_id`() RETURNS int(11)
BEGIN
...
BEGIN
    ...
    insert into z select id, timestamp*1000, data from pvlng_reading_num;
