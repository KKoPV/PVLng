...
CREATE TABLE `pvlng_changes` (
  ...
  `table` enum('babelkit','channel','config','log','options','performance','performance_avg','reading_num','reading_str','tree','type','view') DEFAULT NULL COMMENT 'Table name',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Log data changes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pvlng_performance_avg` (
  `aggregation` enum('hour','day','month','year','overall') NOT NULL DEFAULT 'hour',
  `action` enum('read','write') NOT NULL DEFAULT 'read',
  `year` year(4) NOT NULL DEFAULT '2000',
  `month` smallint(2) unsigned NOT NULL DEFAULT '0',
  `day` smallint(2) unsigned NOT NULL DEFAULT '0',
  `hour` smallint(2) unsigned NOT NULL DEFAULT '0',
  `average` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'ms',
  `count` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`aggregation`,`action`,`year`,`month`,`day`,`hour`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data store perfomance data';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `pvlng_reading_buffer`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pvlng_reading_buffer` (
...
BEGIN
    ...
    IF @extra = '"1"' THEN
        ...
        ELSE
            INSERT INTO `pvlng_reading_num_calc` VALUES(new.`id`, new.`timestamp`, @last + (CAST(new.`timestamp` AS SIGNED) - CAST(@timestamp AS SIGNED)) / 3600 * new.`data`);
        END IF;
...
--
-- Table structure for table `pvlng_reading_num_scatter`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pvlng_reading_num_scatter` (
  `id` smallint(5) unsigned NOT NULL DEFAULT '0',
  `timestamp` int(10) unsigned NOT NULL DEFAULT '0',
  `data` decimal(13,4) NOT NULL DEFAULT '0.0000',
  PRIMARY KEY (`id`,`timestamp`),
...
--
-- Temporary table structure for view `pvlng_reading_stats`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `pvlng_reading_stats` (
  `guid` tinyint NOT NULL,
  `name` tinyint NOT NULL,
  `description` tinyint NOT NULL,
  `numeric` tinyint NOT NULL,
...
CREATE TABLE `pvlng_tree` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `lft` smallint(5) NOT NULL DEFAULT '0',
  `rgt` smallint(5) NOT NULL DEFAULT '0',
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `pvlng_tree_ad` AFTER DELETE ON `pvlng_tree` FOR EACH ROW
BEGIN
...
--
-- Final view structure for view `pvlng_reading_stats`
--

/*!50001 DROP TABLE IF EXISTS `pvlng_reading_stats`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
/*!50001 SET character_set_client      = utf8mb4 */;
...
/*!50001 CREATE  */
/*!50013   */
/*!50001 VIEW `pvlng_reading_stats` AS select `c`.`guid` AS `guid`,`c`.`name` AS `name`,`c`.`description` AS `description`,`c`.`numeric` AS `numeric`,`c`.`decimals` AS `decimals`,`t`.`id` AS `id`,`t`.`timestamp` AS `timestamp`,`t`.`readings` AS `readings`,ifnull(`n`.`data`,`s`.`data`) AS `data` from (((`pvlng_reading_count` `t` left join `pvlng_channel_view` `c` on((`t`.`id` = `c`.`id`))) left join `pvlng_reading_num` `n` on(((`t`.`id` = `n`.`id`) and (`t`.`timestamp` = `n`.`timestamp`)))) left join `pvlng_reading_str` `s` on(((`t`.`id` = `s`.`id`) and (`t`.`timestamp` = `s`.`timestamp`)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 */ /*!50106 EVENT `pvlng_bulk_insert` ON SCHEDULE EVERY 15 SECOND STARTS '2000-01-01 00:00:00' ON COMPLETION PRESERVE ENABLE DO BEGIN
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 */ /*!50106 EVENT `pvlng_daily` ON SCHEDULE EVERY 1 DAY STARTS '2000-01-01 00:00:00' ON COMPLETION PRESERVE ENABLE COMMENT 'Daily tasks' DO BEGIN
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 */ /*!50106 EVENT `pvlng_weekly` ON SCHEDULE EVERY 1 WEEK STARTS '2000-01-02 23:00:00' ON COMPLETION PRESERVE ENABLE COMMENT 'Weekly tasks' DO BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE  FUNCTION `pvlng_api_key`() RETURNS varchar(36) CHARSET utf8
BEGIN
...
DELIMITER ;;
CREATE  FUNCTION `pvlng_mysql_version`() RETURNS varchar(127) CHARSET utf8
RETURN CONCAT(@@version, " ", @@version_comment) ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE  FUNCTION `pvlng_reading_last_num`(`in_id` smallint unsigned) RETURNS decimal(13,4)
RETURN (
    ...
    SELECT `data`
     ...
     WHERE `id` = in_id
       AND `timestamp` = (SELECT MAX(`timestamp`) FROM `pvlng_reading_num` WHERE `id` = in_id)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE  FUNCTION `pvlng_reading_last_str`(`in_id` smallint unsigned) RETURNS varchar(50) CHARSET utf8
RETURN (
    ...
    SELECT `data`
     ...
     WHERE `id` = in_id
       AND `timestamp` = (SELECT MAX(`timestamp`) FROM `pvlng_reading_str` WHERE `id` = in_id)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE  FUNCTION `pvlng_save_data`(`in_id` int unsigned, `in_timestamp` int unsigned, `in_data` char(255)) RETURNS tinyint(1)
    MODIFIES SQL DATA
BEGIN
    -- Return codes
...
where id in (679,680,681,682,706) and
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE  PROCEDURE `pvlng_calc_sensortometer`(IN `in_id` smallint unsigned)
BEGIN
    ...
    DELETE FROM `pvlng_reading_num_calc` WHERE `id` = in_id;
    ...
    REPEAT
        ...
        IF bDone = 0 THEN
            ...
            INSERT INTO `pvlng_reading_num_calc` VALUES (in_id, iTimestamp, fSum);
...
INSERT INTO `pvlng_type` VALUES (0,'Alias','model::Alias','Channel','','general',0,0,0,1,'',0),(1,'Power plant','model::PowerPlant','Channel','','group',-1,0,0,0,'/images/ico/building.png',0),(2,'Inverter','model::Inverter','Channel','','group',-1,0,0,0,'/images/ico/exclamation_frame.png',0),(3,'Building','model::Building','Channel','','group',-1,0,0,0,'/images/ico/home.png',0),(4,'Multi-Sensor','model::MultiSensor','Channel','','group',-1,0,0,0,'/images/ico/wooden_box.png',0),(5,'Group','model::Group','Channel','','group',-1,0,0,0,'/images/ico/folders_stack.png',0),(10,'Random','model::Random','Random','','numeric',0,1,0,1,'/images/ico/ghost.png',0),(11,'Fixed value','model::Fix','Fix','','sensor',0,1,0,1,'/images/ico/chart_arrow.png',0),(12,'Estimate','model::Estimate','Estimate','Wh','sensor',0,1,0,1,'/images/ico/plug.png',0),(13,'Daylight','model::Daylight','Daylight','','sensor',0,1,0,1,'/images/ico/picture-sunset.png',0),(15,'Ratio calculator','model::Ratio','Ratio','','sensor',2,1,0,1,'/images/ico/calculator_scientific.png',0),(16,'Accumulator','model::Accumulator','Accumulator','','numeric',-1,1,0,1,'/images/ico/calculator_scientific.png',0),(17,'Differentiator','model::Differentiator','Differentiator','','numeric',-1,1,0,1,'/images/ico/calculator_scientific.png',0),(18,'Full Differentiator','model::DifferentiatorFull','DifferentiatorFull','','numeric',-1,1,0,1,'/images/ico/calculator_scientific.png',0),(19,'Sensor to meter','model::SensorToMeter','SensorToMeter','Wh','meter',1,1,0,1,'/images/ico/calculator_scientific.png',0),(20,'Import / Export','model::ImportExport','InternalConsumption','','meter',2,1,0,1,'/images/ico/calculator_scientific.png',0),(21,'Average','model::Average','Average','','numeric',-1,1,0,1,'/images/ico/calculator_scientific.png',0),(22,'Calculator','model::Calculator','Calculator','','numeric',1,1,0,1,'/images/ico/calculator_scientific.png',0),(23,'History','model::History','History','','numeric',1,1,0,1,'/images/ico/calculator_scientific.png',0),(24,'Baseline','model::Baseline','Baseline','','sensor',1,1,0,1,'/images/ico/calculator_scientific.png',0),(25,'Topline','model::Topline','Topline','','sensor',1,1,0,1,'/images/ico/calculator_scientific.png',0),(26,'Meter to sensor','model::MeterToSensor','MeterToSensor','','sensor',1,1,0,1,'/images/ico/calculator_scientific.png',0),(27,'Full Accumulator','model::AccumulatorFull','AccumulatorFull','','numeric',-1,1,0,1,'/images/ico/calculator_scientific.png',0),(28,'Selector','model::Selector','Selector','','numeric',2,1,0,1,'/images/ico/ui_check_boxes.png',0),(29,'Multiplier','model::Multiplier','Multiplier','','numeric',-1,1,0,1,'/images/ico/calculator_scientific.png',0),(30,'Dashboard channel','model::Dashboard','Dashboard','','numeric',1,1,0,1,'/images/ico/dashboard.png',0),(31,'Solar Estimate','model::SolarEstimate','SolarEstimate','Wh','sensor',1,1,0,1,'/images/ico/plug.png',0),(32,'Averageline','model::Averageline','Averageline','','sensor',1,1,0,1,'/images/ico/calculator_scientific.png',0),(33,'Percentage calculator','model::Ratio','Ratio','%','sensor',2,1,0,1,'/images/ico/edit_percent.png',0),(40,'Kaco Inverter','model::KacoInverter','Kaco\\RS485','','group',-1,0,1,0,'/images/ico/kaco.png',0),(41,'SMA Inverter','model::SMAInverter','SMA\\Webbox','','group',-1,0,1,0,'/images/ico/sma_inverter.png',0),(42,'SMA Sensorbox','model::SMASensorbox','SMA\\Webbox','','group',-1,0,1,0,'/images/ico/sma_sensorbox.png',0),(43,'Fronius Inverter','model::FroniusSolarNet','Fronius\\SolarNet','','group',-1,0,1,0,'/images/ico/fronius.png',0),(44,'Fronius Sensorbox','model::FroniusSolarNet','Fronius\\SolarNet','','group',-1,0,1,0,'/images/ico/fronius.png',0),(45,'OpenWeatherMap','model::OpenWeatherMap','JSON','','group',-1,0,1,0,'/images/ico/OpenWeatherMap.png',0),(46,'Wunderground','model::Wunderground','JSON','','group',-1,0,1,0,'/images/ico/Wunderground.png',0),(47,'Kostal Piko Inverter','model::KostalPiko','Kostal\\Piko','','group',-1,0,1,0,'/images/ico/kostal_inverter.png',0),(48,'Solar Edge Inverter','model::SolarEdgeInverter','SE\\Inverter','','group',-1,0,1,0,'/images/ico/solar_edge.png',0),(49,'Solar Edge Optimizer','model::SolarEdgeOptimizer','SE\\Optimizer','','group',-1,0,1,0,'/images/ico/solar_edge.png',0),(50,'Energy meter absolute','model::EnergyMeter','Channel','Wh','meter',0,1,1,1,'/images/ico/plug.png',0),(51,'Power sensor','model::PowerSensor','Channel','W','sensor',0,1,1,1,'/images/ico/plug.png',0),(52,'Voltage sensor','model::Voltage','Channel','V','sensor',0,1,1,1,'/images/ico/dashboard.png',0),(53,'Current sensor','model::CurrentSensor','Channel','A','sensor',0,1,1,1,'/images/ico/lightning.png',0),(54,'Gas sensor','model::GasSensor','Channel','m³/h','sensor',0,1,1,1,'/images/ico/fire.png',0),(55,'Heat sensor','model::HeatSensor','Channel','W','sensor',0,1,1,1,'/images/ico/fire_big.png',0),(56,'Humidity sensor','model::Humidity','Channel','%','sensor',0,1,1,1,'/images/ico/weather_cloud.png',0),(57,'Luminosity sensor','model::Luminosity','Channel','lm','sensor',0,1,1,1,'/images/ico/light_bulb.png',0),(58,'Pressure sensor','model::Pressure','Channel','hPa','sensor',0,1,1,1,'/images/ico/umbrella.png',0),(59,'Radiation sensor','model::RadiationSensor','Channel','µSV','sensor',0,1,1,1,'/images/ico/radioactivity.png',0),(60,'Temperature sensor','model::Temperature','Channel','°C','sensor',0,1,1,1,'/images/ico/thermometer.png',0),(61,'Valve sensor','model::Valve','Channel','°','sensor',0,1,1,1,'/images/ico/wheel.png',0),(62,'Water sensor','model::WaterSensor','Channel','m³/h','sensor',0,1,1,1,'/images/ico/water.png',0),(63,'Windspeed sensor','model::Windspeed','Channel','m/s','sensor',0,1,1,1,'/images/ico/paper_plane.png',0),(64,'Irradiation sensor','model::Irradiation','Channel','W/m²','sensor',0,1,1,1,'/images/ico/brightness.png',0),(65,'Timer','model::Timer','Channel','h','meter',0,1,1,1,'/images/ico/clock.png',0),(66,'Frequency sensor','model::FrequencySensor','Channel','Hz','sensor',0,1,1,1,'/images/ico/dashboard.png',0),(67,'Winddirection sensor','model::Winddirection','Channel','°','sensor',0,1,1,1,'/images/ico/wheel.png',0),(68,'Rainfall sensor','model::RainfallSensor','Channel','mm/h','sensor',0,1,1,1,'/images/ico/umbrella.png',0),(69,'Sensor','model::Sensor','Channel','','sensor',0,1,1,1,'/images/ico/system-monitor.png',0),(70,'Gas meter','model::GasMeter','Channel','m³','meter',0,1,1,1,'/images/ico/fire.png',0),(71,'Radiation meter','model::RadiationMeter','Channel','µSV/h','meter',0,1,1,1,'/images/ico/radioactivity.png',0),(72,'Water meter','model::WaterMeter','Channel','m³','meter',0,1,1,1,'/images/ico/water.png',0),(73,'Rainfall meter','model::RainfallMeter','Channel','mm','meter',0,1,1,1,'/images/ico/umbrella.png',0),(74,'Meter','model::Meter','Channel','','meter',0,1,1,1,'/images/ico/chart-up.png',0),(80,'Percentage','model::Percentage','Channel','%','sensor',0,1,1,1,'/images/ico/edit-percent.png',0),(90,'Power sensor counter','model::PowerCounter','Counter','W','sensor',0,1,1,1,'/images/ico/plug.png',0),(91,'Switch','model::Switch','Switcher','','general',0,1,1,1,'/images/ico/ui_check_boxes.png',0),(95,'LaCrosse WS-2300','model::WS2300','WS2300','','group',-1,0,1,0,'/images/ico/ws2300.png',0),(96,'Dark Sky','model::DarkSky','DarkSky','','group',-1,0,1,0,'/images/ico/DarkSky.png',0),(99,'Database usage','Database usage','DatabaseUsage','rows','sensor',0,1,0,1,'/images/ico/database.png',0),(100,'PV-Log Plant','model::PVLogPlant','PVLog\\Plant','','group',-1,1,0,0,'/images/ico/pv_log_sum.png',1),(101,'PV-Log Inverter','model::PVLogInverter','PVLog\\Inverter','','group',-1,1,0,0,'/images/ico/pv_log.png',1),(102,'PV-Log JSON 1.1 Plant','model::PVLogPlant11','PVLog\\Plant11','','group',-1,1,0,0,'/images/ico/pv-log-p.png',0),(103,'PV-Log JSON 1.1 Inverter','model::PVLogInverter11','PVLog\\Inverter11','','group',-1,0,0,0,'/images/ico/pv-log-i.png',0),(110,'Sonnenertrag JSON','model::SonnenertragJSON','Sonnenertrag\\JSON','','group',-1,1,0,0,'/images/ico/sonnenertrag.png',0);
...
INSERT INTO `pvlng_settings` (`scope`, `name`, `key`, `value`, `order`, `type`, `data`) VALUES
('core', '', 'Language', 'de', 10, 'option', 'en:English;de:Deutsch'),
('core', '', 'Title', 'PhotoVoltaic Logger new generation', 20, 'str', ''),
('core', '', 'Latitude', '', 30, 'str', ''),
('core', '', 'Longitude', '', 31, 'str', ''),
('core', '', 'SendStats', 1, 50, 'bool', ''),
('core', '', 'TokenLogin', 1, 60, 'bool', ''),
('core', '', 'KeepLogs', 365, 70, 'num', ''),
('core', '', 'EmptyDatabaseAllowed', 0, 100, 'bool', ''),
('core', 'API', 'Domain', '', 0, 'str', ''),
('core', 'Currency', 'ISO', 'EUR', 80, 'str', ''),
('core', 'Currency', 'Symbol', '€', 81, 'str', ''),
('core', 'Currency', 'Decimals', 2, 82, 'num', ''),
('core', 'Currency', 'Format', '{} €', 83, 'str', ''),
('controller', 'Index', 'ChartHeight', 600, 10, 'num', ''),
('controller', 'Index', 'NotifyAll', 1, 30, 'bool', ''),
('controller', 'Index', 'PresetPeriods', '--;1d;1d;1m', 40, 'str', ''),
('controller', 'Index', 'Refresh', 300, 20, 'num', ''),
('controller', 'Lists', 'PresetPeriods', '--;1d;1d;1m', 0, 'str', ''),
('controller', 'Mobile', 'ChartHeight', 400, 0, 'num', ''),
('controller', 'Tariff', 'TimesLines', 10, 0, 'num', ''),
('controller', 'Weather', 'APIkey', '', 0, 'str', ''),
('model', '', 'DoubleRead', 5, 0, 'num', ''),
('model', 'Daylight', 'Average', 1, 10, 'option', '0:geometric mean;1:arithmetic mean'),
('model', 'Daylight', 'CurveDays', 10, 20, 'num', ''),
('model', 'Daylight', 'SunriseIcon', '/images/sunrise.png', 30, 'str', ''),
('model', 'Daylight', 'SunsetIcon', '/images/sunset.png', 40, 'str', ''),
('model', 'Daylight', 'ZenitIcon', '/images/zenit.png', 50, 'str', ''),
('model', 'Estimate', 'Marker', '/images/energy.png', 0, 'str', ''),
('model', 'History', 'AverageDays', 5, 0, 'num', ''),
('model', 'InternalCalc', 'LifeTime', 60, 0, 'num', '');
...
('Demo - Simpel Sensor and Meter', 1, '{\"2\":\"{\\\"v\\\":2,\\\"axis\\\":2,\\\"type\\\":\\\"areaspline\\\",\\\"style\\\":\\\"Solid\\\",\\\"width\\\":2,\\\"color\\\":\\\"#4572a7\\\",\\\"colorusediff\\\":0,\\\"colordiff\\\":\\\"#404040\\\",\\\"consumption\\\":false,\\\"threshold\\\":0,\\\"min\\\":false,\\\"max\\\":false,\\\"last\\\":true,\\\"all\\\":false,\\\"time1\\\":\\\"00:00\\\",\\\"time2\\\":\\\"24:00\\\",\\\"daylight\\\":false,\\\"daylight_grace\\\":0,\\\"legend\\\":true,\\\"position\\\":0,\\\"hidden\\\":false,\\\"outline\\\":false}\",\"3\":\"{\\\"v\\\":2,\\\"axis\\\":1,\\\"type\\\":\\\"spline\\\",\\\"style\\\":\\\"Solid\\\",\\\"width\\\":2,\\\"color\\\":\\\"#89a54e\\\",\\\"colorusediff\\\":-1,\\\"colordiff\\\":\\\"#db843d\\\",\\\"consumption\\\":false,\\\"threshold\\\":20,\\\"min\\\":true,\\\"max\\\":true,\\\"last\\\":false,\\\"all\\\":false,\\\"time1\\\":\\\"00:00\\\",\\\"time2\\\":\\\"24:00\\\",\\\"daylight\\\":false,\\\"daylight_grace\\\":0,\\\"legend\\\":true,\\\"position\\\":1,\\\"hidden\\\":false,\\\"outline\\\":true}\",\"p\":\"5i\"}'),
('Demo - Sensor with min/max', 1, '{\"2\":\"{\\\"v\\\":3,\\\"axis\\\":1,\\\"type\\\":\\\"areasplinerange\\\",\\\"style\\\":\\\"Solid\\\",\\\"width\\\":2,\\\"color\\\":\\\"#4572a7\\\",\\\"colorusediff\\\":0,\\\"colordiff\\\":\\\"#404040\\\",\\\"consumption\\\":false,\\\"threshold\\\":0,\\\"min\\\":false,\\\"max\\\":false,\\\"last\\\":true,\\\"all\\\":false,\\\"time1\\\":\\\"00:00\\\",\\\"time2\\\":\\\"24:00\\\",\\\"daylight\\\":false,\\\"daylight_grace\\\":0,\\\"legend\\\":true,\\\"position\\\":0,\\\"hidden\\\":false,\\\"outline\\\":false,\\\"stack\\\":\\\"\\\"}\",\"p\":\"20i\"}'),
('Demo - Daily values of Meter', 1, '{\"3\":\"{\\\"v\\\":2,\\\"axis\\\":1,\\\"type\\\":\\\"bar\\\",\\\"style\\\":\\\"Solid\\\",\\\"width\\\":2,\\\"color\\\":\\\"#89a54e\\\",\\\"colorusediff\\\":0,\\\"colordiff\\\":\\\"#000\\\",\\\"consumption\\\":true,\\\"threshold\\\":20,\\\"min\\\":false,\\\"max\\\":true,\\\"last\\\":false,\\\"all\\\":false,\\\"time1\\\":\\\"00:00\\\",\\\"time2\\\":\\\"24:00\\\",\\\"daylight\\\":false,\\\"daylight_grace\\\":0,\\\"legend\\\":true,\\\"position\\\":1,\\\"hidden\\\":false,\\\"outline\\\":true}\",\"p\":\"1d\"}');

INSERT INTO `pvlng_dashboard` (`name`, `public`, `data`) VALUES ('Temperatur', 1, '[5]');

-- Fianally generate and show API key
SELECT `pvlng_api_key`() AS `Your PVLng API key:`;
