...
CREATE TABLE `pvlng_tree` (
  ...
  `entity` smallint(5) unsigned NOT NULL COMMENT 'pvlng_channel -> id',
...
-- ------------------------------------------------------
-- Initial channel data and demo view and demo dashboard
-- ------------------------------------------------------
...
INSERT INTO `pvlng_view` (`name`, `data`) VALUES
('Demo', '{\"p\":\"\",\"2\":\"{\\\"axis\\\":1,\\\"type\\\":\\\"spline\\\",\\\"consumption\\\":false,\\\"style\\\":\\\"Solid\\\",\\\"width\\\":2,\\\"color\\\":\\\"#4572a7\\\",\\\"coloruseneg\\\":true,\\\"colorneg\\\":\\\"#db843d\\\",\\\"threshold\\\":20,\\\"min\\\":false,\\\"max\\\":false}\",\"3\":\"{\\\"axis\\\":2,\\\"type\\\":\\\"spline\\\",\\\"consumption\\\":false,\\\"style\\\":\\\"Solid\\\",\\\"width\\\":2,\\\"color\\\":\\\"#404040\\\",\\\"coloruseneg\\\":false,\\\"colorneg\\\":\\\"#404040\\\",\\\"threshold\\\":0,\\\"min\\\":false,\\\"max\\\":false}\"}');

INSERT INTO `pvlng_dashboard` (`name`, `data`) VALUES
('Demo', '[5]');
