...
('core', '', 'Latitude', '', 30, 'num', ''),
('core', '', 'Longitude', '', 31, 'num', ''),
...
('controller', 'Weather', 'APIkey', '87aedb10be423d15', 0, 'str', ''),
('model', '', 'DoubleRead', 5, 0, 'num', '0:geometric mean;1:arithmetic mean'),
...
-- Add actual database patch level
INSERT INTO `pvlng_config` (`key`, `value`) VALUES ("DBPatchLevel", 11);
