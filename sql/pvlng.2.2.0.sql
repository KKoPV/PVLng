...
('channel',	'de',	'valid_toHint',	'Werte sind nur gültig, wenn sie kleiner oder gleich dieses Wertes sind.\r\nBei beschreibbaren Kanälen werden werden ungültige Werte bereits beim Speichern, bei berechneten Kanälen beim Auslesen verworfen.'),
...
('model',	'en',	'Fix_resolutionHint',	'Creates 2 data points, at start and at of selected time range.'),
('model',	'de',	'DaylightHelp',	'Sollte bei Faktor = 1 als Scatter (Marker) im Diagramm angezeigt werden'),
('model',	'de',	'EstimateHelp',	'Sollte als Scatter (Zielmarke) im Diagramm angezeigt werden'),
('model',	'en',	'DaylightHelp',	'Should for Factor = 1 be shown as Scatter (marker) in chart'),
